...
contract FunctionVisibilityTest is Test {
    ...
    function testPublicFunction() public view {
        ...
        assertEq(
            result,
            "Public Function",
            "Public function should return 'Public Function'"
        );
    }
    ...
    function testPublicMessage() public view {
        ...
        assertEq(
            ...
            "Public message should be 'Public Function Called'"
        );
    }
    ...
    function testPrivateFunction() public view {
        ...
        assertEq(
            result,
            "Private Function",
            "Private function should return 'Private Function'"
        );
    }
    ...
    function testInternalFunction() public view {
        ...
        assertEq(
            result,
            "Internal Function",
            "Internal function should return 'Internal Function'"
        );
    }
    ...
    function testInternalFunctionInDerivedContract() public view {
        ...
        assertEq(
            result,
            "Internal Function",
            "Internal function in derived contract should return 'Internal Function'"
        );
    }
    ...
    function testExternalFunction() public view {
        ...
        assertEq(
            result,
            "External Function",
            "External function should return 'External Function'"
        );
    }
}
